            ...
            <div className="flex  flex-col gap-6 items-start">
              ...
              <div className="flex items-center gap">
                <button
                  ...
                  className="bg-orange-400 text-white  font-bold py-2 px-4 rounded-l-md"
                >
                  -
                </button>
                <button
                  onClick={() => context.removeFromBasket(book.id)}
                  className="bg-orange-400 text-white   font-bold py-2 px-4 "
                >
                  Remove
                </button>
                <button
                  onClick={() => context.increase(book.id)}
                  className="bg-orange-400 text-white  font-bold py-2 px-4 rounded-r-md"
                >
                  +
                </button>
              </div>
